...
<head>
    ...
    <script>
                    ...
                    .success(function(result) {
                        ...
                        if(obj != '')
                        {
                            $.each(obj, function(key, val) {
                                ...
                                load(branchData,branchCode,branchName,branchType,branchTel,branchAddress,branchContact,email,start,end,keywords,select_top,b);
                            });
                        }
                    });
            });
        ...
        //}
        function load(branchData,branchCode,branchName,branchType,branchTel,branchAddress,branchContact,email,start,end,keywords,select_top,session) 		{
                    ...
                    .success(function(result) {
                        ...
                        if(obj != '')
                        {
							$("#load").text("กำลังโหลดไฟล์...");
								$.post('Print-Order-All-Product-F.php', { 
								resultData:result,
								date_start:start,
								branch:branchName,
								date_end:end
   								...
   								//alert(result); 			
								window.location = 'MyPDF/File-Order-All-Product-F.pdf';
							});
                            /*$.each(obj, function (key, val) {
