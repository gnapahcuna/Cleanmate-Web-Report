...
<head>
	<title>สรุปยอดประเภทบริการลูกค้าประจำร้าน</title>
	<meta charset="utf-8">
...
*/
        ...
        function getDataFromDb()
        {
            ...
            if(end!=''){
                var html=''+
                    '<a href="PDF/Load-Customer-Service-F.php?date_start='+start+'&date_end='+end+'&keywords='+keywords+'&keywords2='+keywords2+'&session='+session+'&select_top='+select_top+'" target="_blank" rel="noopener noreferrer">'+
                    ...
                    .success(function(result) {
                        ...
                        if(obj != '')
                        {
                            ...
                            $.each(obj, function(key, val) {
                                ...
                                tr = tr + "<td style='color: #0c1312'><center>" + val["total"] + "</center></td>";
		...
		<div class="sidebar-scroll">
			<nav>
				<ul class="nav">
					...
					<li><a href="Customer-Service-F.php" class="active"><i class="lnr lnr-chart-bars"></i> <span>8. สรุปยอดประเภทบริการลูกค้าประจำร้าน</span></a></li>
					...
					<?php }elseif($value=='025'){ $indexes++; ?>
					<li><a href="Customer-Service-F.php" class="active"><i class="lnr lnr-chart-bars"></i> <span>5. สรุปยอดประเภทบริการลูกค้าประจำร้าน</span></a></li>
                                    ...
                                    tooltips: {
                                        callbacks: {
                                            label: function(tooltipItem, data) {
                                                ...
                                                return (currentValue).toFixed().replace(/\d(?=(\d{3})+\.)/g, '$&,') +" ("+percentage + "%)";
                                            }
                                        }
                                    }
                                }
						...
						<div class="table-responsive">
							<table class="table table-bordered" id="myTable">
								...
								<tr>
									...
									<th rowspan="2" style="vertical-align : middle;text-align:center;" bgcolor="#2b333e"><font color="white"> <center>ชื่อ-นามสกุล</center></font> </th>
									<th rowspan="2" style="vertical-align : middle;text-align:center;" bgcolor="#2b333e"><font color="white"> <center>เบอร์มือถือ</center></font> </th>
									<th rowspan="2" style="vertical-align : middle;text-align:center;" bgcolor="#2b333e"><font color="white"> <center>ประเภทลูกค้า</center></font> </th>
									<th colspan="7" bgcolor="#2b333e"><font color="white"> <center>จำนวน (ชิ้น)</center></font> </th>
									<th rowspan="2" style="vertical-align : middle;text-align:center;" bgcolor="#2b333e"><font color="white"> <center>รวมจำนวนชิ้น</center></font> </th>
									<th rowspan="2" style="vertical-align : middle;text-align:center;" bgcolor="#2b333e"><font color="white"> <center>ใช้บริการครั้งล่าสุด วดป</center></font> </th>
								</tr>
								<tr>
