...
sum(SpecialDiscount) as SpecialDiscount from (ops_order
...
$stmt1="select top 10 ops_order.OrderNo,sum(PromoDiscount) as PromoDiscount,sum(ops_order.IsExpress) as counts from (ops_order
left join (mas_branch left join mas_branchtype on mas_branch.BranchID=mas_branchtype.BranchTypeID)
on ops_order.BranchID=mas_branch.BranchID)
WHERE  ops_order.OrderDate BETWEEN  '".$date_start."' AND '".$date_end."' AND ops_order.IsActive='1'
AND mas_branch.BranchID='".$session."'
...
$stmt1="select top 20 ops_order.OrderNo,sum(PromoDiscount) as PromoDiscount,sum(ops_order.IsExpress) as counts from (ops_order
left join (mas_branch left join mas_branchtype on mas_branch.BranchID=mas_branchtype.BranchTypeID)
on ops_order.BranchID=mas_branch.BranchID)
WHERE  ops_order.OrderDate BETWEEN  '".$date_start."' AND '".$date_end."' AND ops_order.IsActive='1'
AND mas_branch.BranchID='".$session."'
...
$stmt1="select top 30 ops_order.OrderNo,sum(PromoDiscount) as PromoDiscount,sum(ops_order.IsExpress) as counts from (ops_order
left join (mas_branch left join mas_branchtype on mas_branch.BranchID=mas_branchtype.BranchTypeID)
on ops_order.BranchID=mas_branch.BranchID)
WHERE  ops_order.OrderDate BETWEEN  '".$date_start."' AND '".$date_end."' AND ops_order.IsActive='1'
AND mas_branch.BranchID='".$session."'
...
$stmt1="select ops_order.OrderNo,sum(PromoDiscount) as PromoDiscount,sum(ops_order.IsExpress) as counts from (ops_order
left join (mas_branch left join mas_branchtype on mas_branch.BranchID=mas_branchtype.BranchTypeID)
on ops_order.BranchID=mas_branch.BranchID)
WHERE  ops_order.OrderDate BETWEEN  '".$date_start."' AND '".$date_end."' AND ops_order.IsActive='1'
AND mas_branch.BranchID='".$session."'
...
Order By ops_order.OrderNo ASC";
		...
		,'SpecialDiscount' => $arrSpecail[$i],'Total' => $arrTotal[$i]-$arrPromo[$i]-$arrMember[$i]-$arrSpecail[$i]));
					}
