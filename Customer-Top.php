...
<head>
	<title>รายงานลูกค้าประจำร้าน Top 30</title>
	<meta charset="utf-8">
		...
		<div class="sidebar-scroll">
			<nav>
				<ul class="nav">
					...
					<li><a href="Customer-Top.php" class="active"><i class="lnr lnr-chart-bars"></i> <span>6. รายงานลูกค้าประจำร้าน Top 30</span></a></li>
