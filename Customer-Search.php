...
<head>
	<title>รายงานค้นหาข้อมูลยอดขายบริการลูกค้าประจำร้าน</title>
	<meta charset="utf-8">
...
*/
        ...
        function getDataFromDb()
        {
            ...
            var input = document.getElementById("keywords3").value;
            var keywords3="";
            if(input==""){
                keywords3='cheese';
            }else{
                keywords3=$("#keywords3").val();
            }
            ...
            //alert(select_top+","+start+","+end+","+keywords2+","+keywords+","+keywords3+","+session);

            if(end!=''){
                var html=''+
                    '<a href="PDF/Load-Customer-Search.php?date_start='+start+'&date_end='+end+'&keywords='+keywords+'&keywords2='+keywords2+'&keywords3='+keywords3+'&session='+session+'&select_top='+select_top+'" target="_blank" rel="noopener noreferrer">'+
            ...
            $.get( "path.txt", function( data ) {
                var resourceContent = data;
                $.ajax({
                    url: resourceContent+"/CustomerSearch.php?select_top="+select_top+
                    "&date_start="+start +
                    "&date_end="+end +
                    "&keywords2="+keywords2+
                    "&keywords="+keywords+
		...
		<div class="sidebar-scroll">
			<nav>
				<ul class="nav">
					...
					<li><a href="Customer-Search.php" class="active"><i class="lnr lnr-chart-bars"></i> <span>7. รายงานค้นหาข้อมูลยอดขายบริการลูกค้าประจำร้าน</span></a></li>
					<?php }
					}?>
					<?php }?>
				</ul>
					...
					<div class="panel">
						...
						<div class="panel-body">
							...
							<form id='myform1' method="post">
								...
								<input type="text" name="keywords3" id="keywords3" class="form-control" v placeholder="ค้นหาชื่อ, สกุล, เบอร์มือถือลูกค้า" onchange="return getDataFromDb()" required>
								<br>-->
							...
							<div class="input-group">
								<input class="form-control" id="keywords3" name="keywords3" type="text" placeholder="ค้นหาชื่อ, สกุล, เบอร์มือถือลูกค้า">
							...
							<form id='myform2' method="post">
								...
								<!--<label>ค้นหาชื่อร้าน</label><br>
								<input type="text" name="keywords3" id="keywords3" class="form-control" placeholder="ค้นหาชื่อ, สกุล, เบอร์มือถือลูกค้า" onchange="return getDataFromDb()" required>
								<br>-->
				...
				<div class="col-md-6">
					...
					<div class="panel">
						...
						if($_SESSION['BranchID']!=1){
							...
							?>
						<form id="myform3">
							<input type="hidden" name="select_top" id="select_top" value="" ?>
